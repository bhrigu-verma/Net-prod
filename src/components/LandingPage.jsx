  ...
  return (
    <div>
      ...
      <div
        ...
        className="h-[32rem] w-full sm:h-[65vh] xl:h-[100vh] bg-slate-800 relative"
      >
    ...
    Already a user?
        ...
        <div className="grid pb-[139px] content-center justify-center h-full justify-items-center">
          <div className="w-10/12 text-center sm:w-11/12 md:w-40rem">
              ...
              <h1 className="mb-4 text-[16px] text-center text-stone-200 font-light sm:text-2xl">
                Watch anywhere.Cancel anytime
              </h1>
              <h1 className="mb-2 text-center text-stone-200 font-light sm:text-xl sm:mb-8">
      ...
      <section className="bg-black border-y-8 border-y-zinc-800  justify-center">
          ...
          <div className="flex justify-center md:py-8">
            <div className="lg:flex lg:items-center lg:w-9/12">
              <div>
                <h1 className="mt-[140px] mb-[70px] text-4xl font-semibold text-center text-white lg:mt-0 lg:text-left lg:ml-8 lg:text-5xl xl:text-6xl">
                  Enjoy on your TV.
                </h1>
